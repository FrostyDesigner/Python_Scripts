...
#change the mlb icon color to blue
for lt, ln, tm in zip(lat_mlb, lon_mlb, team_mlb):
    fgmlb.add_child(folium.Marker(location=[lt, ln], popup=folium.Popup(str(tm), parse_html=True), icon=folium.Icon(color="blue")))
...
map.save("C:\GitHub\Python_Scripts\WebmapsWithFolium\World_Map_with_MLB.html")
